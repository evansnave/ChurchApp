$(document).ready(function () {
    ...
    $('#add_member').click(function () {
        ...
        $('#members_form')[0].reset();
        $('.modal-title').html("<i class='fa fa-plus'></i> Add Teen");
        $('#action').val("Add teen");
        $('#btn_action').val("Add");
    });
    ...
    $(document).on('click', '.update', function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('.modal-title').html("<i class='fa fa-pencil-square-o'></i> Edit Teen");
                $('#id').val(id);
                $('#action').val('Edit Teen');
                $('#btn_action').val('Edit');
                fetch_data();
            }
        })
        ...
        function SwalDelete(member_id) {
            swal({
                title: 'Are you sure?',
                text: "Teen will be deleted permanently!",
                type: 'info',
                ...
                preConfirm: function () {
                    return new Promise(function (resolve) {
                        ...
                        $.ajax({
                                url: 'operations/delete/teens.php',
                                type: 'POST',
