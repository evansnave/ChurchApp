        ...
        <form method="post" id="cell_form">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title"><i class="fa fa-plus"></i> Add Offertory</h4>
                </div>
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <select name="offering_type" id="offering_type" class="form-control">
                            ...
                            <option value="Praise and Worship Offering">Praise and Worship Offering</option>
                ...
                <div class="modal-footer text-center">
                    ...
                    <input type="submit" name="action" id="action" class="btn btn-primary" value="Add Offertory" />
