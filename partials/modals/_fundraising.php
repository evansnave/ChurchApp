        ...
        <form method="post" id="cell_form">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title"><i class="fa fa-plus"></i> Add Fundraising</h4>
                </div>
                <div class="modal-body">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" name="fundraising_type" id="fundraising_type" class="form-control" required />
                    </div>
                     <div class="form-group">
                        <label>Amount</label>
                ...
                <div class="modal-footer text-center">
                    ...
                    <input type="submit" name="action" id="action" class="btn btn-primary" value="Add Fundraising" />
