...
if ($_SESSION['role'] == 'cell_leader') {
    ...
    $query = "SELECT * FROM cell_first_timers WHERE firstTimer_status='active' AND date_added = '$actual_date' AND cell = $cell_id ORDER BY fullname";
} else {
    $query = "SELECT * FROM cell_first_timers WHERE firstTimer_status='active' AND date_added = '$actual_date' ORDER BY fullname";
}
        ...
        <tbody>
            ...
            foreach ($rows as $result) {
                ...
                <tr>
                    ...
                    <td><?=nameOfCell($db,$result['cell']) ?></td>
